...
export type AdminUploadItem = { file: File; relativePath?: string };

export type AdminUploadBatchCallbacks = {
...
export async function adminUploadFilesBatch(
  ...
  options: {
    ...
    callbacks?: AdminUploadBatchCallbacks;
  }
