  ...
  return (
    <div>
      ...
      <p className="mb-6 text-sm text-zinc-500">
        No serial, IMEI, or model — each unit gets a unique ASTEHS ID with a unified EN code per tool type. Tools go into a global pool; choose DT or Driver/Rigger when assigning.
      </p>
