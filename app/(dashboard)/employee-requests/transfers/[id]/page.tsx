  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-wrap items-center gap-4">
        <Link href="/employee-requests" className="text-sm text-zinc-500 hover:text-zinc-900">
          ← Employee requests
        </Link>
      ...
      <p className="text-sm text-zinc-600">
        QC and Project Managers can accept or reject from the{" "}
        <span className="font-medium text-zinc-800">employee portal</span> (Transfer requests).
      </p>
    </div>
  );
}
