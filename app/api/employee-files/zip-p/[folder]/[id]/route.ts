...
/**
 * Short public ZIP link: `/api/employee-files/zip-p/{folderName}/{linkId}`
 * Search chats by folder name; `linkId` is a 12-char key stored in `employee_site_zip_share_links`.
 */
